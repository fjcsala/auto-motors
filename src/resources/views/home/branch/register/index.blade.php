    ...
    <form method="post" action="{{ url('home/branch/create') }}">
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    <label>CNPJ</label>
                    <input class="form-control" id="cnpj" name="cnpj" type="text" value="{{ old('cnpj') }}" autofocus>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="form-group">
                    <label>Inscrição Estadual</label>
                    <input class="form-control" id="ie" name="ie" type="text" value="{{ old('ie') }}">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input class="form-control" id="social_name" name="social_name" type="text" value="{{ old('social_name') }}">
                </div>
            </div>
            <div class="col-sm-6">
                <div class="form-group">
                    <label>Nome Fantasia</label>
                    <input class="form-control" id="fantasy_name" name="fantasy_name" type="text" value="{{ old('fantasy_name') }}">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    <label>CEP</label>
                    <input class="form-control" id="zip_code" name="zip_code" type="text" value="{{ old('zip_code') }}">
                </div>
            </div>
            <div class="col-sm-6">
                <!-- empty space -->
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input class="form-control" id="complement" name="complement" type="text" value="{{ old('complment') }}">
                </div>
            </div>
            <div class="col-sm-6">
                <div class="form-group">
